...
- [ ] 2.1 Pin `plugins/coolify/.mcp.json` to `@jurislm/coolify-mcp@3.6.0` and update Coolify-owned package references in `plugins/coolify/README.md`, `plugins/coolify/skills/coolify/SKILL.md`, and `openspec/specs/infra/coolify-detail.md` without changing credentials or release-managed versions.
