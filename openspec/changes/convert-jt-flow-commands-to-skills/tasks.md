...
- [x] 1.1 Create `plugins/jt-flow/skills/jt-flow-one/SKILL.md` by migrating `plugins/jt-flow/commands/jt-flow.md`, replacing command frontmatter, `$ARGUMENTS`, and slash-command references with Skill frontmatter, natural-language trigger phrases, and a reference to the `jt-flow-all` Skill.
- [x] 1.2 Create `plugins/jt-flow/skills/jt-flow-all/SKILL.md` by migrating `plugins/jt-flow/commands/jt-flow-all.md`, replacing command frontmatter, `$ARGUMENTS`, and slash-command references with Skill frontmatter, natural-language trigger phrases, and direct delegation to the `jt-flow-one` Skill.
