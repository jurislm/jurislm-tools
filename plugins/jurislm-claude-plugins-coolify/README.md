...
```
/plugin install jurislm-claude-plugins-coolify@jurislm-plugins
```
...
- [jurislm-coolify-mcp](https://github.com/terry90918/coolify-mcp)（forked from @masonator/coolify-mcp）
